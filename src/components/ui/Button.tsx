...
export default function Button({ children, variant = 'primary', href, className = '', onClick, type = 'button' }: Props) {
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-cyan to-electric hover:from-amber-500 hover:to-accent-gold text-navy shadow-md shadow-cyan/10 hover:shadow-lg hover:shadow-cyan/25',
    ...
    outline: 'border border-cyan/30 text-navy bg-gray-50/40 hover:bg-gradient-to-r hover:from-cyan hover:to-electric hover:text-navy hover:border-transparent shadow-sm hover:shadow-md',
  }
