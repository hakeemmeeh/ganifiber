...
export default function FeaturedProjects() {
  ...
  return (
    <section ref={containerRef} className="relative py-28 bg-navy overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-navy/92 pointer-events-none" />
      <div className="absolute inset-0 bg-dot-matrix-dark opacity-10 pointer-events-none" />

      {/* Glowing orbs */}
      <div className="absolute top-1/3 left-[10%] w-72 h-72 bg-electric/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-[10%] w-64 h-64 bg-accent-gold/8 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <AnimatedText
            ...
            className="font-syne font-bold text-3xl lg:text-5xl text-white text-center justify-center tracking-tight"
          />
          <motion.p
            ...
            className="text-gray-400 text-base md:text-lg mt-5 max-w-2xl mx-auto leading-relaxed"
          >
          ...
          {projects.map((project, i) => {
            ...
            return (
              <motion.div
                key={i}
                variants={fadeInUp}
                className="group relative rounded-[2rem] overflow-hidden border border-white/10 hover:border-accent-gold/40 transition-all duration-700 cursor-pointer bg-white/[0.03] backdrop-blur-sm"
              >
                ...
                <div className="relative h-56 lg:h-64 overflow-hidden">
                  ...
                  {/* Stats pill */}
                  <div className="absolute bottom-4 right-4 bg-white/10 backdrop-blur-md border border-white/15 text-white text-xs font-semibold px-3 py-1.5 rounded-full">
                    {project.stats}
                  </div>

                  {/* Floating icon */}
                  <div className="absolute bottom-4 left-4 w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 flex items-center justify-center group-hover:bg-accent-gold/20 group-hover:border-accent-gold/40 transition-all duration-500">
                    <ProjectIcon size={22} className="text-white group-hover:text-accent-gold transition-colors duration-500" />
                  </div>
                </div>
                ...
                <div className="p-6 lg:p-7">
                  ...
                  <h3 className="font-syne font-bold text-lg text-white mb-2 group-hover:text-accent-gold transition-colors duration-500">
                    {project.title}
                  </h3>
